...
const Tutorial = () => {
  const courses = [
    ...
    { title: "Programming Python", levels: 5, difficulty: "Beginner", image: python},
    { title: "Programming Java", levels: 4, difficulty: "Beginner", image: java },
    { title: "Aptitude", levels: 6, difficulty: "Beginner", image: aptitude },
    { title: "Data Structure", levels: 11, difficulty: "Beginner", image:  ds },
    { title: "Database Programming", levels: 1, difficulty: "Beginner", image: dbms },
    { title: "Problem Solving Skills", levels: 1, difficulty: "Beginner", image: solve },
  ];
      ...
      <div className="courses-grid">
        {courses.map((course, index) => (
          <div className="course-card" key={index}>
            ...
            <p><FontAwesomeIcon icon={faBook} /> Levels: {course.levels}</p>
            <p><FontAwesomeIcon icon={faLayerGroup} />Difficulty: {course.difficulty}</p>
            </div>
          {/*  */}
          </div>
        ))}
